...
fun LoginScreen(
    ...
    Column(
        ...
        MikoriTextButton(text = "¿Olvidaste tu contraseña?", onClick = { viewModel.forgotPassword(email) })

        Spacer(Modifier.height(Spacing.lg))
        MikoriTextButton(text = "Crear una cuenta nueva", onClick = onGoToRegister)
    }
}
